...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    "booking.fare_brand": "Marca da Tarifa",
    ...
    "scan.step_ocr": "Reconhecendo texto...",
    "scan.step_parsing": "Extraindo dados...",
    "scan.step_done": "Concluído!",
    "scan.step_preparing": "Preparando imagem...",
    "scan.step_enhancing": "Melhorando qualidade...",
    "scan.attempt_mrz_zone": "Lendo zona MRZ...",
    "scan.attempt_enhanced": "Tentando com imagem melhorada...",
    "scan.attempt_original": "Tentando com imagem original...",
    "scan.multi_attempt_notice": "Analisando com diferentes técnicas para melhor resultado...",
    ...
    "scan.no_mrz_found": "Não foi possível encontrar a zona de leitura (MRZ) no documento. Certifique-se de que a parte inferior do documento está visível.",
    "scan.ocr_error": "Erro ao processar a imagem. Tente novamente com uma foto mais nítida.",
    ...
    "confirm.booking_id": "ID da Reserva",
  ...
  en: {
    ...
    "scan.step_ocr": "Recognizing text...",
    "scan.step_parsing": "Extracting data...",
    "scan.step_done": "Done!",
    "scan.step_preparing": "Preparing image...",
    "scan.step_enhancing": "Enhancing quality...",
    "scan.attempt_mrz_zone": "Reading MRZ zone...",
    "scan.attempt_enhanced": "Trying with enhanced image...",
    "scan.attempt_original": "Trying with original image...",
    ...
    "scan.no_mrz_found": "Could not find the machine-readable zone (MRZ) on the document. Make sure the bottom of the document is visible.",
    "scan.ocr_error": "Error processing the image. Try again with a clearer photo.",
  ...
  es: {
    ...
    "booking.fare_brand": "Marca de Tarifa",
    ...
    "scan.step_ocr": "Reconociendo texto...",
    "scan.step_parsing": "Extrayendo datos...",
    "scan.step_done": "Listo!",
    "scan.step_preparing": "Preparando imagen...",
    "scan.step_enhancing": "Mejorando calidad...",
    "scan.attempt_mrz_zone": "Leyendo zona MRZ...",
    "scan.attempt_enhanced": "Intentando con imagen mejorada...",
    "scan.attempt_original": "Intentando con imagen original...",
    "scan.multi_attempt_notice": "Analizando con diferentes técnicas para el mejor resultado...",
    ...
    "scan.no_mrz_found": "No se pudo encontrar la zona de lectura (MRZ) en el documento. Asegúrese de que la parte inferior del documento sea visible.",
    "scan.ocr_error": "Error al procesar la imagen. Intente de nuevo con una foto más nítida.",
    ...
    "confirm.booking_id": "ID de Reserva",
