...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    "trips.subtitle": "Veja e gerencie suas reservas de voos",
    "trips.no_bookings": "Nenhuma reserva encontrada",
    "trips.no_bookings_desc": "Você ainda não tem nenhuma reserva. Faça sua primeira busca!",
    "trips.search_flights": "Buscar Voos",
    "trips.booking_ref": "Referência",
    "trips.booked_on": "Reservado em",
    "trips.view_details": "Ver Detalhes",
    "trips.status.confirmed": "Confirmada",
    "trips.status.pending": "Pendente",
    "trips.status.cancelled": "Cancelada",
    "trips.status.test": "Teste",
    "trips.lookup.title": "Consultar Reserva",
    "trips.lookup.subtitle": "Encontre sua reserva com o código de referência e e-mail",
    "trips.lookup.reference": "Código de Referência",
    "trips.lookup.reference_placeholder": "Ex: MT-ABC123",
    "trips.lookup.email": "E-mail do Contato",
    "trips.lookup.email_placeholder": "seu@email.com",
    "trips.lookup.search": "Buscar Reserva",
    "trips.lookup.not_found": "Reserva não encontrada",
    "trips.lookup.not_found_desc": "Verifique o código de referência e o e-mail e tente novamente.",
    "trips.lookup.or_login": "Ou faça login para ver todas as suas reservas",
  },
  en: {
    // Header & Footer
    "nav.flights": "Flights",
    ...
    "trips.subtitle": "View and manage your flight bookings",
    "trips.no_bookings": "No bookings found",
    "trips.no_bookings_desc": "You don't have any bookings yet. Search for your first flight!",
    "trips.search_flights": "Search Flights",
    ...
    "trips.lookup.title": "Look Up Booking",
    "trips.lookup.subtitle": "Find your booking with your reference code and email",
    "trips.lookup.reference": "Reference Code",
    "trips.lookup.reference_placeholder": "e.g. MT-ABC123",
    "trips.lookup.email": "Contact Email",
    "trips.lookup.email_placeholder": "your@email.com",
    "trips.lookup.search": "Find Booking",
    "trips.lookup.not_found": "Booking not found",
    "trips.lookup.not_found_desc": "Please check the reference code and email and try again.",
    "trips.lookup.or_login": "Or sign in to see all your bookings",
  },
  es: {
    // Header & Footer
    "nav.flights": "Vuelos",
    ...
    "trips.subtitle": "Vea y administre sus reservas de vuelos",
    "trips.no_bookings": "No se encontraron reservas",
    "trips.no_bookings_desc": "Aún no tiene ninguna reserva. Busque su primer vuelo!",
    ...
    "trips.status.confirmed": "Confirmada",
    "trips.status.pending": "Pendiente",
    "trips.status.cancelled": "Cancelada",
    "trips.status.test": "Prueba",
    "trips.lookup.title": "Consultar Reserva",
    "trips.lookup.subtitle": "Encuentre su reserva con el código de referencia y correo electrónico",
    "trips.lookup.reference": "Código de Referencia",
    "trips.lookup.reference_placeholder": "Ej: MT-ABC123",
    "trips.lookup.email": "Correo de Contacto",
    "trips.lookup.email_placeholder": "su@correo.com",
    "trips.lookup.search": "Buscar Reserva",
    "trips.lookup.not_found": "Reserva no encontrada",
    "trips.lookup.not_found_desc": "Verifique el código de referencia y el correo e intente nuevamente.",
    "trips.lookup.or_login": "O inicie sesión para ver todas sus reservas",
  }
};
