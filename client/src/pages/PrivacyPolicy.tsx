...
const pt = {
  ...
  s1l3: "Dados de conta: informações de login via autenticação Replit — para acesso seguro à sua conta",
...
const en = {
  ...
  s1l3: "Account data: login information via Replit authentication — for secure access to your account",
...
const es = {
  ...
  s1l3: "Datos de cuenta: información de inicio de sesión mediante autenticación Replit — para acceso seguro a su cuenta",
