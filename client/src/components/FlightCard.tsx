        ...
        <div className="md:col-span-5 flex flex-col justify-center px-4 md:px-0">
          <div className="flex justify-between items-end mb-2">
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 leading-none" data-testid="text-departure-time">{format(parseISO(flight.departureTime), "HH:mm")}</div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 leading-none" data-testid="text-arrival-time">{format(parseISO(flight.arrivalTime), "HH:mm")}</div>
              <div className="text-xs text-gray-500 font-semibold uppercase tracking-wide mt-1">
