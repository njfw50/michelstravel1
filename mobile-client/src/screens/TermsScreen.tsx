...
type TermsContent = {
  ...
  s2Title: string; s2p1: string; s2p2: string; s2p3: string; s2p4: string;
  s3Title: string; s3p1: string; s3p2: string; s3p3: string; s3p4: string;
  s4Title: string; s4p1: string; s4p2: string; s4p3: string; s4p4: string;
  s5Title: string; s5p1: string; s5p2: string; s5p3: string; s5p4: string;
  s6Title: string; s6p1: string; s6p2: string; s6p3: string; s6p4: string;
  s7Title: string; s7p1: string; s7l1: string; s7l2: string; s7l3: string; s7l4: string; s7l5: string;
  s8Title: string; s8p1: string; s8p2: string; s8p3: string;
...
function getContent(lang: string): TermsContent {
  if (lang === "es") return esContent as TermsContent;
  if (lang === "en") return enContent as TermsContent;
  return ptContent as TermsContent;
}
...
export function TermsScreen({ navigation }: { navigation: any }) {
  ...
  const sections = [
    { title: content.s1Title, paragraphs: [content.s1p1, content.s1p2, content.s1p3] },
    { title: content.s2Title, paragraphs: [content.s2p1, content.s2p2, content.s2p3, content.s2p4] },
    { title: content.s3Title, paragraphs: [content.s3p1, content.s3p2, content.s3p3, content.s3p4] },
    { title: content.s4Title, paragraphs: [content.s4p1, content.s4p2, content.s4p3, content.s4p4] },
    { title: content.s5Title, paragraphs: [content.s5p1, content.s5p2, content.s5p3, content.s5p4] },
    { title: content.s6Title, paragraphs: [content.s6p1, content.s6p2, content.s6p3, content.s6p4] },
    { title: content.s7Title, paragraphs: [content.s7p1], bullets: [content.s7l1, content.s7l2, content.s7l3, content.s7l4, content.s7l5] },
    { title: content.s8Title, paragraphs: [content.s8p1, content.s8p2, content.s8p3] },
    { title: content.s9Title, paragraphs: [content.s9p1, content.s9p2, content.s9p3] },
  ];
    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        <TouchableOpacity onPress={() => navigation.goBack()} style={styles.backButton}>
          <Text style={styles.backText}>{content.backHome}</Text>
        </TouchableOpacity>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.contactCard}>
          <Text style={styles.contactIntro}>{content.contactIntro}</Text>
