...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: theme.colors.gray50 },
  container: {
  ...
  modeBullets: { marginTop: theme.spacing(3.5), gap: theme.spacing(2) },
  modeBulletLight: { color: "rgba(255,255,255,0.9)", fontSize: 12.5, lineHeight: 19, fontWeight: "600" },
  modeButtonLight: {
    marginTop: theme.spacing(4),
    borderRadius: theme.radius.lg,
    backgroundColor: theme.colors.white,
